  ...
  if (file.is_open())
    {
      while (getline(file,value))
        {
          // cout<<atof(value.c_str())<<endl;
          s[c++] = atof(value.c_str());
        }
    }
  return s;
}
